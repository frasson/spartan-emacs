...
(setq org-capture-templates
      '(    
        ...
        ("n" "Note"
         entry (file+headline "~/Documents/notes/notes.org" "Random Notes")
         "** %?"
         :empty-lines 0)
        ...
        ("d" "Door Codes"
         entry (file+headline "~/Documents/notes/notes.org" "Door Codes")
         "** %?"
         :empty-lines 0)

        ("g" "General To-Do"
         entry (file+headline "~/Documents/notes/todos.org" "General Tasks")
         "* TODO [#B] %?\n:Created: %T\n "
         :empty-lines 0)
        ...
        ("c" "Code To-Do"
         entry (file+headline "~/Documents/notes/todos.org" "Code Related Tasks")
         "* TODO [#B] %?\n:Created: %T\n%i\n%a\nProposed Solution: "
         :empty-lines 0)
